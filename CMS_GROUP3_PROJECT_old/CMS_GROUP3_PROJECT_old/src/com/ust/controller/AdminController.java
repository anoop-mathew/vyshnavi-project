...
import com.ust.dao.AdminDaoInterface;
...
public class AdminController {
	...
	public void insertDoctorComments(@RequestBody DoctorObservation obs,@PathVariable("regId") int regId,@PathVariable("dId") int dId) {
	...
	public void updateMedicine(@RequestBody Medicine a1,@PathVariable("medId") int medId) {
